  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#050506] px-4 py-16 text-white sm:px-6 lg:px-8">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-[-10%] top-[12%] h-72 w-72 rounded-full bg-primary/10 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-3xl rounded-[32px] border border-white/10 bg-[#0C0C0F]/90 p-8 shadow-[0_30px_120px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:p-12">
        <p className="mb-4 text-xs uppercase tracking-[0.35em] text-primary/80">Checkout canceled</p>
        <h1 className="font-serif text-4xl text-white sm:text-5xl">Your billing session was canceled.</h1>
        <p className="mt-4 max-w-2xl text-sm leading-7 text-white/65 sm:text-base">
          No charges were confirmed. You can start again whenever you are ready to unlock the Pro Creator plan.
        </p>
